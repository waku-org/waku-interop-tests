...
ETH_CLIENT_ADDRESS = get_env_var("ETH_CLIENT_ADDRESS")
ETH_TESTNET_KEY = get_env_var("ETH_TESTNET_KEY")
GO_WAKU_ETH_TESTNET_KEY = get_env_var("GO_WAKU_ETH_TESTNET_KEY")
NWAKU_ETH_TESTNET_KEY = get_env_var("NWAKU_ETH_TESTNET_KEY")
KEYSTORE_PASSWORD = get_env_var("KEYSTORE_PASSWORD")
ETH_CONTRACT_ADDRESS = get_env_var("ETH_CONTRACT_ADDRESS")
