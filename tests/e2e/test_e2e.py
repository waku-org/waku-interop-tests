...
class TestE2E(StepsFilter, StepsStore, StepsRelay, StepsLightPush):
    ...
    def test_relay_six_nodes(self):
        ...
        self.node6.start(relay="true", filter="true", filternode=self.node4.get_multiaddr_with_id(), discv5_bootstrap_node=self.node5.get_enr_uri())
        ...
        self.check_published_message_is_stored(page_size=50, ascending="true", store_node=self.node4, messages_to_check=[msg1])
